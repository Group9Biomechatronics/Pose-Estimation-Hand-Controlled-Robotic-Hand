...
def radiantoDegrees(Angle_in_Radian):
        ...
        if hands:
            ...
            if (handType1 == "Right"):
                for i in range(len(fingers1)):
                    ...
                    if fingers1[i] == 1:
                        SetAngle(180, servoPIN1, pwm1)
                    else: SetAngle(0, servoPIN1, pwm1)
                    
                    if fingers1[i] == 2:
                        SetAngle(180, servoPIN2, pwm2)
                    else: SetAngle(0, servoPIN2, pwm2)
                    
                    if fingers1[i] == 3:
                        SetAngle(180, servoPIN3, pwm3)
                    else: SetAngle(0, servoPIN3, pwm3)
                    
                    if fingers1[i] == 4:
                        SetAngle(0, servoPIN4, pwm4)
                    else: SetAngle(180, servoPIN4, pwm4)
                    
                    if fingers1[i] == 5:
                        SetAngle(0, servoPIN5, pwm5)
                    else: SetAngle(180, servoPIN5, pwm5)         
